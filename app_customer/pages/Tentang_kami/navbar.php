...
<nav>
    <div class="navbar-container">
        ...
        <form method="GET" action="../search.php" class="search-bar">
            <input class="Desktop-view" type="text" name="query" placeholder="Cari di Toko Bangunan Agung Jaya..." required>
        ...
        <ul class="nav-links" id="navLinks">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-content">
                    <li><a class="dropdown-item" href="profil_toko.php#profil">Profil Toko</a></li>
                    <li><a class="dropdown-item" href="profil_toko.php#visi-misi">Visi & Misi</a></li>
                    <li><a class="dropdown-item" href="profil_toko.php#lokasi">Lokasi & Layanan</a></li>
                    <li><a class="dropdown-item" href="profil_toko.php#kontak">Kontak Kami</a></li>
                </ul>
            </li>
